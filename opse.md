...
*A minimal, all-in-one toolkit to play your favourite tabletop RPGs without a GM.*
...
| Rank | Detail | Rank | Detail |
|------|--------|------|--------|
| 2 | Small | 9 | Unsavoury |
| 3 | Large | T (10) | Specialised |
| 4 | Old | J | Unexpected |
| 5 | New | Q | Exotic |
...
|------|-------|------|-------|
| 2 | Current Need | 9 | Rumours |
| 3 | Allies | T (10) | A Plot Arc |
...
| Rank | Identity | Rank | Identity |
|------|----------|------|----------|
| 2 | Outlaw | 9 | Entertainer |
| 3 | Drifter | T (10) | Adherent |
...
| 6 | Location for a specialised purpose |
...
There are a great many excellent tools out there to run a solo RPG game. Many of them, however, are overly complicated. You shouldn't have to read 15 pages of rules and make 10 dice rolls just to determine what the guards in a room are doing.
...
When playing a non-PbtA game, it is important to remember that not every failure should result in a GM Move. Sometimes the Spot check just fails because there was nothing there. GM Moves should be used when a roll fails and there are consequences for failure, or the action needs to pick up. Checking the room for secret doors? Probably not. Climbing a cliff in the rain to escape a group of cultists? Definitely.
...
A playing card carries more information than a die roll, and the suits work well for applying a "domain" to the results. Instead of having a huge table with every adjective you can pull from the dictionary, you have a smaller table with more general words and a domain that they can apply to. This results in more interpretation and less guesswork.
...
**Written by:** Karl Hendricks — Inflatable Studios  
**Email:** support@inflatablestudios.dev  
**Reddit:** u/archon1024  
**Download:** https://inflatablestudios.itch.io/  
**Licence:** CC-BY-SA 4.0 — Free to use and adapt for your own works (even commercially) as long as you provide credit and share your changes.
